...
const ChatMessage = ({ message }) => {
  ...
  return (
    <div className={`ai-msg ${message.role}`}>
      ...
      <div>
        <div className="ai-msg-bubble">{formatText(message.content)}</div>
            ...
            {message.products.map((product) => (
              <div className="ai-product-card" key={product._id}>
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://via.placeholder.com/64?text=ShopNest";
                  }}
                />
                <div className="ai-product-info">
                  <div className="ai-product-name" title={product.name}>
                    {product.name}
                  </div>
                  <div className="ai-product-meta">
                    <span className="ai-product-price">₹{product.price}</span>
                    <span className="ai-product-rating">
                  ...
                  <div className="ai-product-actions">
                    <button
                      className="ai-product-btn primary"
                    ...
                    {product.stock > 0 && (
                      <button
                        className="ai-product-btn secondary"
